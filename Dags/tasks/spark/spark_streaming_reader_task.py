...
class SparkKafkaStreamingReader:
    ...
    def __init__(self, kafka_bootstrap_servers='broker:29092', topic='users_nord_created', starting_offsets='earliest'):
        """
        Initialise le lecteur Kafka Spark.

        :param kafka_bootstrap_servers: Adresse des serveurs Kafka (par ex. 'broker:29092')
        :param topic: Nom du topic Kafka à lire (par ex. 'users_nord_created')
