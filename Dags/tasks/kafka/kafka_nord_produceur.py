...
class KafkaDataNordPublisherTask:
    """
    Cette classe publie des données formatées dans un topic Kafka - topic nord.

    Attributes:
        None
    """
    
    def streaming_data_nord(self, doawloaddata, formatData):
        """
        Cette méthode envoie des données téléchargées et formatées au topic Kafka 'users_nord_created'.
        ...
        try:
            ...
            producer.send('users_nord_created', json.dumps(format_data).encode('utf-8'))
